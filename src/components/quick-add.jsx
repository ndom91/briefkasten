                ...
                <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                  ...
                  <div className="bg-slate-50 p-4">
                    <div className="flex space-x-2 text-right px-4">
                      <button
                        onClick={submitUrl}
                        className="inline-flex transition justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-slate-800 hover:bg-slate-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-500 items-center"
                      >
                        {loading ? (
                          <svg
                      ...
                      <button
                        onClick={clearInputs}
                        className="inline-flex transition justify-center py-2 px-4 border border-transparent shadow-sm text-slate-700 text-sm font-medium rounded-md border-slate-600 hover:text-white hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-500"
                      >
                        Clear
                      </button>
                    </div>
