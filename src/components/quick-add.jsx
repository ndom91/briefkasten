        ...
        {() => (
          <>
            ...
            >
              <Popover.Panel
                static
                className="absolute bottom-24 right-8 z-[56] mt-3 hidden w-full max-w-sm origin-bottom-right px-4 sm:px-0 md:block md:max-w-xl"
              >
                <div
                  ref={popoverRef}
                ...
                >
                  ...
                  <div className="bg-slate-50 p-4">
                    <div className="flex justify-start px-4">
                      <button
                        onClick={submitUrl}
                        className="inline-flex w-1/3 items-center justify-center rounded-md border border-transparent bg-slate-800 px-4 py-2 text-sm font-medium text-white shadow-sm transition hover:bg-slate-900 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:ring-offset-2"
                      >
                        {loading ? (
                          <svg
            ...
            <Transition
              ...
              leaveTo="opacity-0"
            >
              <Popover.Overlay className="fixed left-0 top-0 z-[55] h-full w-full bg-black bg-opacity-40 transition" />
            </Transition>
          </>
        )}
      </Popover>
