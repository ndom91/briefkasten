      ...
      <td className={`px-6 ${editMode ? "py-2" : "py-4"}`}>
        {!editMode ? (
          ...
          <input
            ...
            className="block w-full rounded-md border-2 border-slate-200 bg-slate-50 px-2 py-1 text-sm text-xl text-slate-900 placeholder-slate-300 focus:border-slate-500 focus:ring-slate-500"
          />
        )}
      </td>
      <th className="px-6 py-4">
